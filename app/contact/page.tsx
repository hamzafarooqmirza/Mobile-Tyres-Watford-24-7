    ...
    <main className="pb-20 md:pb-0">
      ...
      <section className="py-14 sm:py-20 bg-[#060e20] border-b border-[#1e2d4a]">
        <div className="px-4 md:px-12 max-w-[1280px] mx-auto">
          <p className="font-mono text-[#e11d48] text-[11px] uppercase tracking-[0.2em] font-bold mb-3">Get In Touch</p>
          <h1 className="text-[36px] sm:text-[48px] md:text-[64px] font-extrabold tracking-tight leading-[1.05] text-white mb-4">
            Contact <span className="text-[#e11d48]">Us</span>
          </h1>
      ...
      <section className="bg-[#0b1326] border-b border-[#1e2d4a]">
        ...
        <div className="grid grid-cols-2 sm:hidden border-b border-[#1e2d4a]">
          <a
            ...
            className="flex flex-col items-center justify-center gap-1 py-4 bg-[#e11d48] text-white font-bold text-[12px] uppercase tracking-wide"
          >
        ...
        <div className="hidden sm:grid sm:grid-cols-2 lg:grid-cols-4 gap-5 px-4 md:px-12 max-w-[1280px] mx-auto py-12">
          <a
            href="tel:07466756907"
            className="contact-card group bg-[#131b2e] border border-[#1e2d4a] rounded-2xl p-6 hover:border-[#e11d48]/40 hover:shadow-lg hover:shadow-[#e11d48]/5 transition-all text-center"
          >
            <div className="w-12 h-12 rounded-2xl bg-[#e11d48]/10 border border-[#e11d48]/20 flex items-center justify-center mx-auto mb-3 group-hover:bg-[#e11d48]/20 transition-colors">
              <span className="material-symbols-outlined text-[#e11d48] text-[24px]">local_shipping</span>
            </div>
            <p className="font-mono text-[10px] text-[#e11d48] uppercase tracking-[0.15em] font-bold mb-1">Mobile Service</p>
          ...
          >
            <div className="w-12 h-12 rounded-2xl bg-[#e11d48]/10 border border-[#e11d48]/20 flex items-center justify-center mx-auto mb-3 group-hover:bg-[#e11d48]/20 transition-colors">
              <span className="material-symbols-outlined text-[#e11d48] text-[24px]">call</span>
            </div>
            <p className="font-mono text-[10px] text-[#e11d48] uppercase tracking-[0.15em] font-bold mb-1">Office</p>
          ...
          <a
            ...
            className="contact-card group bg-[#131b2e] border border-[#1e2d4a] rounded-2xl p-6 hover:border-[#ffb3b6]/30 hover:shadow-lg hover:shadow-[#ffb3b6]/5 transition-all text-center"
          >
            <div className="w-12 h-12 rounded-2xl bg-[#ffb3b6]/10 border border-[#ffb3b6]/20 flex items-center justify-center mx-auto mb-3 group-hover:bg-[#ffb3b6]/20 transition-colors">
              <span className="material-symbols-outlined text-[#ffb3b6] text-[24px]">mail</span>
            </div>
            <p className="font-mono text-[10px] text-[#ffb3b6] uppercase tracking-[0.15em] font-bold mb-1">Email</p>
        ...
        <div className="sm:hidden divide-y divide-[#1e2d4a]">
          ...
          <a href="mailto:Mirahmed0101@gmail.com" className="flex items-center gap-4 px-4 py-4">
            <span className="material-symbols-outlined text-[#ffb3b6] text-[20px] shrink-0">mail</span>
            <div>
          ...
          <div className="flex items-center gap-4 px-4 py-4">
            <span className="material-symbols-outlined text-[#e11d48] text-[20px] shrink-0">location_on</span>
            <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-3 reveal">
              ...
              <form className="space-y-4" onSubmit={sendToWhatsApp}>
                ...
                <div>
                  ...
                  <input type="text" placeholder="e.g. 2021 Volkswagen Golf" value={form.vehicle} onChange={set('vehicle')} className="w-full bg-[#131b2e] border border-[#1e2d4a] text-white placeholder-[#4a5f80] rounded-xl py-3.5 px-4 outline-none focus:border-[#e11d48] transition-colors text-[14px]" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea placeholder="Any additional details…" rows={3} value={form.notes} onChange={set('notes')} className="w-full bg-[#131b2e] border border-[#1e2d4a] text-white placeholder-[#4a5f80] rounded-xl py-3.5 px-4 outline-none focus:border-[#e11d48] transition-colors resize-none text-[14px]" />
                </div>
            ...
            <div className="lg:col-span-2 flex flex-col gap-6">
              ...
              <div className="reveal hidden sm:block bg-[#131b2e] border border-[#1e2d4a] rounded-2xl p-6">
                <p className="font-mono text-[11px] text-[#e11d48] uppercase tracking-[0.15em] font-bold mb-5">Location &amp; Contact</p>
                <div className="space-y-4">
                  ...
                  <a href="tel:07466756907" className="flex gap-3 items-start group">
                    ...
                    <div>
                      ...
                      <p className="text-white font-bold text-[17px] group-hover:text-[#e11d48] transition-colors">07466 756907</p>
                    </div>
                  </a>
                  <a href="tel:01923240599" className="flex gap-3 items-start group">
                    ...
                    <div>
                      ...
                      <p className="text-white font-bold text-[17px] group-hover:text-[#e11d48] transition-colors">01923 240599</p>
                    </div>
                  </a>
              ...
              <div className="reveal bg-[#131b2e] border border-[#1e2d4a] rounded-2xl overflow-hidden">
                <div className="px-5 py-4 border-b border-[#1e2d4a]">
                  <p className="font-mono text-[11px] text-[#e11d48] uppercase tracking-[0.15em] font-bold">Availability</p>
                </div>
                <div className="px-5 py-3 border-b border-[#1e2d4a]">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="material-symbols-outlined text-[#e11d48] text-[16px]">local_shipping</span>
                  ...
                  {shopHours.map((row) => {
                    ...
                    return (
                      <div
                        key={row.day}
                        className={`flex justify-between items-center py-2 text-[13px] border-b border-[#1e2d4a]/40 last:border-0 ${isToday ? 'bg-[#e11d48]/5 -mx-5 px-5' : ''}`}
                      >
                        <span className={`font-medium flex items-center gap-2 ${isToday ? 'text-white' : 'text-[#9aadcc]'}`}>
                          {row.day}
                          {isToday && <span className="font-mono text-[9px] bg-[#e11d48] text-white px-1.5 py-0.5 rounded uppercase tracking-wide">Today</span>}
                        </span>
                ...
                <div className="px-5 py-4 bg-[#e11d48]/5">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="material-symbols-outlined text-[#e11d48] text-[16px]">schedule</span>
                    <span className="font-mono text-[10px] text-[#4a5f80] uppercase tracking-widest font-bold">Emergency — 24/7</span>
                  </div>
                  <p className="text-[#ffb3b6] font-bold text-[14px]">24 / 7 — Anytime</p>
      ...
      <section id="faq" className="py-14 sm:py-20 bg-[#131b2e] border-t border-[#1e2d4a]">
        <div className="px-4 md:px-12 max-w-[720px] mx-auto">
          <div className="text-center mb-10 reveal">
            <p className="font-mono text-[#e11d48] text-[11px] uppercase tracking-[0.2em] font-bold mb-2">FAQ</p>
